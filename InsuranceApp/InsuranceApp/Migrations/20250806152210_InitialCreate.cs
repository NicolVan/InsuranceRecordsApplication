        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsuredPersons_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedDamage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    InsuranceId = table.Column<int>(type: "int", nullable: false),
                    InsuredPersonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceParticipants_Insurances_InsuranceId",
                        column: x => x.InsuranceId,
                        principalTable: "Insurances",
                        principalColumn: "InsuranceId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InsuranceParticipants_InsuredPersons_InsuredPersonId",
                        column: x => x.InsuredPersonId,
                        principalTable: "InsuredPersons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceParticipants_InsuranceId",
                table: "InsuranceParticipants",
                column: "InsuranceId");

            migrationBuilder.CreateIndex(
                name: "IX_InsuranceParticipants_InsuredPersonId",
                table: "InsuranceParticipants",
                column: "InsuredPersonId");
